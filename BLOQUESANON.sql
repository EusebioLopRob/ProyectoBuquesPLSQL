...
--SELECT USUARIO,TO_CHAR(FECHA,'DD/MM/YYYY HH24:MI:SS')AS "FECHA HORA",TIPO_TRANSACCION,REGISTRO_NUEVO,REGISTRO_ANTIGUO FROM BARCO_AUDITORIA;
--SELECT USUARIO,TO_CHAR(FECHA,'DD/MM/YYYY HH24:MI:SS')AS "FECHA HORA",TIPO_TRANSACCION,REGISTRO_NUEVO,REGISTRO_ANTIGUO FROM COMANDANTE_AUDITORIA;
--SELECT USUARIO,TO_CHAR(FECHA,'DD/MM/YYYY HH24:MI:SS')AS "FECHA HORA",TIPO_TRANSACCION,REGISTRO_NUEVO,REGISTRO_ANTIGUO FROM CONTIENDA_AUDITORIA;
--SELECT USUARIO,TO_CHAR(FECHA,'DD/MM/YYYY HH24:MI:SS')AS "FECHA HORA",TIPO_TRANSACCION,REGISTRO_NUEVO,REGISTRO_ANTIGUO FROM PARTICIPA_AUDITORIA;
